...
mys_pkgs <- c("tidyverse", "curl", "eurostat", "here", "palmerpenguins", "quantmod", "rio", "gt", "DT", "gapminder", "markdown", "knitr")
...
my_pkgs <- c("devtools", "data.table", "quanteda", "rstudio/TinyTeX")
pak::pkg_install(mys_pkgs)
...
-   [**Aula Virtual de la asignatura**](https://aulavirtual.uv.es/course/view.php?id=100631){target="_blank"}: como Aula Virtual es el sitio oficial de la asignatura colgaré allí los anuncios de tipo "oficial". También colgaré en Aula Virtual los detalles sobre la evaluación. 
